...
type AvailabilitySpec struct {
	...
	// RuntimeClassName refers to a RuntimeClass object in the cluster, which should be used to run this pod.
	// If no RuntimeClass resource matches the named class, the pod will not be run.
	// If unset or empty, the "legacy" RuntimeClass will be used, which is an empty value that disables this feature.
