...
export TEST_INSTANCE_NAME TEST_NAMESPACE OPENCLAW_IMAGE_SPEC MODEL_ID SECRET_NAME AWS_REGION
envsubst < "${TEMPLATE_DIR}/k8s-manifests/openclaw-instance.yaml.tpl" | kubectl apply -f -
